...
//        this.setBackgroundColor(Color.BLACK);
        ...
        notScrollBarBg = resources.getDrawable(R.drawable.ui_seekbarpressure_bg_progress);
        hasScrollBarBg = resources.getDrawable(R.drawable.ui_seekbarpressure_bg_normal);
        mThumbLow = resources.getDrawable(R.drawable.ui_seekbarpressure_thumb);
        mThumbHigh = resources.getDrawable(R.drawable.ui_seekbarpressure_thumb);
