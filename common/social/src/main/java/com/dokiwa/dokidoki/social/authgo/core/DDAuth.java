...
import com.dokiwa.dokidoki.social.authgo.core.entities.DDUser;
import com.dokiwa.dokidoki.social.socialgo.annotation.Unsupported;
...
public class DDAuth extends DDSocial implements IAuth, IDDAPIEventHandler {
    ...
    public void auth() {
        ...
        req.state = "dd_auth_" + String.valueOf(System.currentTimeMillis());
